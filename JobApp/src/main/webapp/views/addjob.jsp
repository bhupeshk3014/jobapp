...
<%@ page isELIgnored="false"%>
	...
	<title>Bhupesh Job Portal</title>
	<link
	...
	<body>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-warning">
			<div class="container">
				<a class="navbar-brand fs-1 fw-medium" href="#">Bhupesh Job
					Portal Web App</a>
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav ms-auto">
						...
						<li class="nav-item"><a class="nav-link" href="https://bhupeshk3014.github.io/portfolio/">Contact</a>
						</li>
					</ul>
				</div>
			</div>
